...
class Company(Base):
    ...
    # Evaboot / LinkedIn Sales Navigator enrichment columns
    ...
    employee_growth_1y_pct = Column(Float)
    funding_stage = Column(String(500), index=True)
    discovery_method = Column(String(50), server_default="qlgen")
